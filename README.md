...
**Status:** Phase 1 (data pipeline) complete. Ingestion, global test holdout, and non-IID
partitioning into four bank shards are implemented and approved; see `PLAN.md`'s progress log.
